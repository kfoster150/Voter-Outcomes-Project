...
results <- boot(data = regressiondata, statistic = coeffs_boot_func, R = 10000,  data = regressiondata, formula = Raw2016 ~ CollegePlusRatio2016 + MedianIncome2016 + MedianAge2016)
