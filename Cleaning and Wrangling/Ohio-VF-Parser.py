...
newvars = ["voter_id", "first_name", "middle_name", \
    ...
    "turnout2012", "turnout2014","turnout2016" ,"party_affiliation2008", \
    "party_affiliation2010", "party_affiliation2012", "party_affiliation2014", \
"party_affiliation2016","party_affiliation", "residential_address","city","state","zipcode","precinct_name","precinct_code"]
...
# party_affiliation_2016 = [95]
# party_affiliation = 10
# residential_address = 11 + 12
# city = 13
# state = 14
# zipcode = 15
# precinct_name = 38
...
for row in reader:
    ...
    values = [row[0], row[4], row[5], row[3], row[7], row[8],"NA", 
        1 if row[70] is 'X' else 0, 1 if row[80] is 'X' else 0, 
        1 if row[85] is 'X' else 0, 1 if row[91] is 'X' else 0, 
        1 if row[99] is 'X' else 0, row[68], row[77], row[84], row[90], 
        row[10], address,row[13],row[14],row[15],row[38],row[39]]
    county = county_keys[row[1]]
